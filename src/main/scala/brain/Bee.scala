...
object Bee extends App {
  ...
  vertx
    .deployVerticleFuture(ScalaVerticle.nameForVerticle[brain.Bee])
    .onComplete {
...
class Bee extends ScalaVerticle {

  override def stopFuture(): Future[_] = {

    var unpublishRecordFuture = Bee.discovery.unpublishFuture(Bee.record.getRegistration)
  ...
  override def startFuture(): Future[_] = {
    ...
    Bee.discovery.publishFuture(Bee.record).onComplete{
    ...
    println(s"🌍 🐝 Bee Listening on $httpPort  - Enjoy 😄")
